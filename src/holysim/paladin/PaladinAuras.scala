...
import holysim.engine.{Modifier, Aura}
import holysim.engine.Mod._

trait PaladinAuras { this: Paladin =>
	object aura {
		/**
		 * Character base stats
		 */
		object BaseStats extends Aura("Base Stats") with Aura.Modifiers {
			val modifiers = BaseIntellect(1304) :: BaseStamina(1000) :: BaseSpirit(768) :: Nil
		}
		 ...
		 */
		object IlluminatedHealing extends Aura("Mastery: Illuminated Healing") {
